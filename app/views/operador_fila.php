<?php $page_title = 'Operador - SIGEF'; require __DIR__ . '/partials/header.php'; ?> 
 ...
 function renderTabela($itens, $acao_tipo, $placeholder_input = "", $nome_botao = "", $is_ob = false, $is_lote = false) { 
     ...
     foreach($itens as $i) { 
         ...
         if (!$is_lote) { 
             // Apenas mostra botão individual se NÃO for lote
         ...
         // 🛡️ CORREÇÃO DO BUG HTML5 REQUIRED
         ...
         echo "  <input type='hidden' name='item_id' value='{$i['id']}'> 
                 ...
                 <input type='text' name='observacao' placeholder='Motivo...' {$attr_required} style='padding:5px; border:1px solid #dc3545; border-radius:4px; width:150px;'>"; 
 ...
 // Submissão individual via JavaScript quando estamos dentro de uma tabela de Lote
